...
namespace Mercat\UI\components\boxes\presupuesto;
...
class PresupuestoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", MercatUIUtils::formatMontoToView( $this->getPresupuesto()->getMonto() ) );
		
		
		
		$xtpl->assign( "observaciones", $this->getPresupuesto()->getObservaciones() );
		$xtpl->assign( "fecha", MercatUIUtils::formatDateTimeToView($this->getPresupuesto()->getFecha()) );
