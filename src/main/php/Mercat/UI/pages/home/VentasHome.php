...
class VentasHome extends MercatPage{
	...
	public function parseStatsVentas(XTemplate $xtpl){
		...
		$xtpl->assign("monto_ventas", MercatUIUtils::formatMontoToView($totalesDia["monto"]) );
		...
		$xtpl->assign("monto_ventas_mes", MercatUIUtils::formatMontoToView($totalesMes["monto"]) );
	...
	public function parseDebitosCreditos( XTemplate $xtpl){
		...
		foreach ($debitosCreditos as $informeDebitoCredito) {
			...
			$xtpl->assign("titulo", MercatUIUtils::formatDateToView( $informeDebitoCredito->getFechaVencimiento()) );

			if($informeDebitoCredito->getDebito()){
				$xtpl->assign("subtitulo", MercatUIUtils::formatMontoToView($informeDebitoCredito->getDebito()) );
				$xtpl->assign("descripcion", "Débito" );
			}else{
				$xtpl->assign("subtitulo", MercatUIUtils::formatMontoToView($informeDebitoCredito->getCredito()) );
	...
	*/
	...
	public function parseGastos( XTemplate $xtpl){
		...
		foreach ($gastos as $gasto) {
			$xtpl->assign("titulo", MercatUIUtils::formatDateToView( $gasto->getFechaVencimiento()) );
			$xtpl->assign("subtitulo", MercatUIUtils::formatMontoToView($gasto->getMonto()) );
